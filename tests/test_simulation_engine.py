...
class SimulationEngineTests(unittest.TestCase):
    ...
    def test_plan_changes_model_and_evidence_depth(self):
        ...
        self.assertEqual(professional.representative_agents, 96)
        self.assertTrue(professional.customer_calibration)
        self.assertEqual(deep.execution_backend, "not_deployed")
