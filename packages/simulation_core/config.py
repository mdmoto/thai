...
PLAN_CONFIGS: Dict[str, PlanConfig] = {
    ...
    "BASIC_DECISION": PlanConfig(
        code="BASIC_DECISION",
        default_population=20_000,
        maximum_population=20_000,
        default_mc_rounds=140,
        maximum_mc_rounds=180,
        model_family="hybrid_journey_mixed_logit",
        model_sample_size=20_000,
        representative_agents=24,
        agent_signal_weight=0.04,
        competitor_limit=4,
        elasticity_points=7,
        dynamic_periods=12,
        customer_calibration=False,
        data_depth="structured_agent_signals_and_multi_stage_consumer_journey",
        execution_backend="inline",
    ),
