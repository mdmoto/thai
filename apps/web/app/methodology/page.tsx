...
export default function MethodologyPage() {
  return (
    <LegalPage title="方法、数据与可信度边界">
      ...
      <Section title="线下门店与选址">
        系统在运行时解析泰国候选地址，统计周边营业地点，并计算 5、10、15 分钟步行路网范围。
        步行商圈内常住人口使用 WorldPop 2025 年约 100 米人口模型数据，并在生产环境聚合至约 500 米计算。
        消费者选择模型决定产品本身的到店倾向，地理机会只作有限幅度修正，不再单独接管购买率。
        “到店机会指数”结合常住人口、交通、商业活跃和旅游设施，只用于比较机会，不是电信手机信令、商场闸机或支付交易记录。
        地点综合机会分若未使用客户多店客流拟合，会明确标为“权重未校准”；小时访问没有客户记录时也只标为经营先验。
      </Section>
